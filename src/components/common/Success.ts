...
export class Success extends Component<ISuccess> {
    ...
    constructor(protected container: HTMLElement, events: IEvents, operation?: ISuccessActions) {
            super(container);

            this.orderSuccessDescription = container.querySelector('.order-success__description'); 
